...
def start_gmrf_launch(config):
    return subprocess.Popen(
        [
            ...
            f"GMRF_lambdaPrior_advection:={config.gmrf_lambda_advection}",
            f"GMRF_lambdaPrior_mass_conservation:={config.gmrf_lambda_mass_conservation}",
            f"GMRF_lambdaPrior_diffusion:={config.gmrf_lambda_diffusion}",
...
def run_case(config: ScenarioConfig, sample_file_csv: Path, sample_size: int,
    ...
    metadata = {
        ...
        "gmrf_lambda_advection": float(config.gmrf_lambda_advection),
        "gmrf_lambda_mass_conservation": float(config.gmrf_lambda_mass_conservation),
        "gmrf_lambda_diffusion": float(config.gmrf_lambda_diffusion),
        "gmrf_lambda_obstacles": float(config.gmrf_lambda_obstacles),
        "gmrf_num_iterations_MAP": int(config.gmrf_num_iterations_map),
